...
export default function AdminLayout({
  ...
  if (pathname === "/admin") {
    return (
      <div
        style={{ minHeight: "100vh", background: "var(--navy)", color: "#fff" }}
      >
        {children}
      </div>
    );
  ...
  const menu = [
    ...
    { label: "Korporat", path: "/admin/corporate", icon: FileText },
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{ padding: "24px 16px", borderTop: "1px solid var(--border)" }}
        >
          <Link
            href="/login"
            style={{
