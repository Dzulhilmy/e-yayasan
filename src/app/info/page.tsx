...
function FeaturedCarousel({ items }: { items: any[] }) {
  ...
  if (!item) {
    return (
      ...
      >
        Tiada info tersedia buat masa ini.
      </div>
    );
  }
...
export default function InfoPage() {
  ...
  const categories = [
    "Semua",
    ...Array.from(new Set(infos.map((i) => i.category))),
  ];
      ...
      >
        ...
        <div className="container">
          ...
          >
            ...
            >
              Ikuti perkembangan terkini, notis rasmi, kempen dan pengumuman
              daripada Yayasan Perak.
            </p>
          </div>
        </div>
      </section>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              ...
              <Link
                ...
                style={{
                  ...
                  textDecoration: "none",
                  background:
                    "linear-gradient(135deg, rgba(139,92,246,0.15) 0%, var(--navy-card) 100%)",
              ...
              >
                ...
                <div>
                  ...
                  >
                    Kata-kata ilham dari Yayasan Perak
                  </p>
                </div>
                <ExternalLink
                  size={16}
