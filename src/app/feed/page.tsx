...
export default function FeedPage() {
      ...
      if (!error && data && data.length > 0) {
        ...
        const formatted = data.map((item: any) => {
          ...
          return {
            ...
            icon:
              item.icon_name === "Users"
                ? Users
                : item.icon_name === "Leaf"
                  ? Leaf
                  : item.icon_name === "TrendingUp"
                    ? TrendingUp
                    : BookOpen,
  ...
  const filtered = news.filter((n) => {
    const matchCat =
      activeCategory === "Semua" || n.category === activeCategory;
    ...
    <>
      <div className="page-hero">
        ...
        <div className="container">
          ...
          >
            Ikuti perkembangan terbaru Yayasan Perak. Simpan artikel untuk
            dibaca kemudian.
          </p>
        </div>
      </div>
        ...
        >
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      inset: 0,
                      background:
                        "linear-gradient(to top, rgba(10,22,40,0.8) 0%, transparent 40%)",
                      pointerEvents: "none",
                    }}
                  />
                </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div className="card">
              ...
              >
                <Bookmark size={16} style={{ color: "var(--gold)" }} /> Artikel
                Tersimpan
              </h3>
              {news.filter((n: any) => saved[n.id]).length === 0 ? (
                <p style={{ color: "var(--text-muted)", fontSize: "0.84rem" }}>
                  Tiada artikel tersimpan.
                </p>
              ) : (
                news
                  .filter((n: any) => saved[n.id])
                  .map((n: any) => (
                    <div
                      key={n.id}
                      style={{
            ...
            <div className="card">
              ...
              {[
                {
                  title: "Seminar EDP 4: The Art Of Negotiation",
                  date: "14-15 Jan 2026",
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    "linear-gradient(to top, var(--navy-card) 0%, transparent 50%)",
                }}
              />
            </div>
            ...
            <div style={{ padding: "0 32px 32px" }}>
              ...
              >
                <span className={`badge ${selectedArticle.tag}`}>
              ...
              >
                ...
                <p>
                  Portal e-YP akan sentiasa dikemaskini dengan kandungan berita
                  penuh dari pangkalan data Yayasan Perak tidak lama lagi. Terus
              ...
              <div style={{ marginTop: 32, display: "flex", gap: 12 }}>
                ...
                >
                  <Bookmark
                    size={18}
                    fill={saved[selectedArticle.id] ? "currentColor" : "none"}
                    style={{
                      color: saved[selectedArticle.id]
                        ? "var(--gold)"
                        : "currentColor",
                    }}
                  />
                  {saved[selectedArticle.id]
                    ? "Artikel Tersimpan"
                    : "Simpan Artikel"}
                </button>
              </div>
